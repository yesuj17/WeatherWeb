...
function WemsAnalysisController($scope, $http) {
    ...
    function refreshPowerData(analysisDataSet) {
        ...
        var xAxesLabel = getXScaleLabelString(wemsAnalysisVM.selectedDateUnit);
        var yAxesLabel = '( kW )';
        ...
        powerChart.options.title.text = titleName;
        powerChart.options.scales.xAxes[0].scaleLabel.labelString = xAxesLabel;
        powerChart.options.scales.yAxes[0].scaleLabel.labelString = yAxesLabel;
    ...
    function refreshCumulativeCycleTimeData(analysisDataSet) {
        ...
        cumulativeCycleTimeChart.data = cumulativeCycleTimeData;
        cumulativeCycleTimeChart.options.scales.xAxes[0].scaleLabel.labelString = xAxesLabel;
        cumulativeCycleTimeChart.update();
    }
    ...
    function refreshPowerEfficiencyBarChart(analysisDataSet) {
        ...
        powerEfficiencyBarChart.data = powerEfficiencyData;

        powerEfficiencyBarChart.update();
    }
    ...
    function refreshPowerEfficientyLineChart(analysisDataSet) {
        ...
        powerEfficiencyLineChart.data = powerEfficiencyData;
        powerEfficiencyLineChart.options.scales.xAxes[0].scaleLabel.labelString = xAxesLabel;

        powerEfficiencyLineChart.update();
    }
    ...
    function getCumulativeCycleTimeDataSet(analysisDataSet) {
        ...
        var lastYearCumulativeCycleTimeDataSet = {
            label: '작년',
            type: 'line',  // override the default type
            fill: false,
            backgroundColor: "black",
        ...
        cumulativeCycleTimeDataSet.push(lastYearCumulativeCycleTimeDataSet);
